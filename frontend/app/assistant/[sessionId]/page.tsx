...
export default function AssistantPage() {
  ...
  return (
    <div className="fixed inset-0 flex flex-col bg-slate-50 text-slate-800">
      {/* Header */}
      <header className="shrink-0 bg-white border-b border-slate-200">
        <div className="flex items-center gap-3 px-5 h-16">
          ...
          <div className="ml-auto flex items-center gap-4">
            <div className="hidden sm:flex items-center gap-2.5 w-56">
            ...
            <button onClick={() => setAutoSpeak((v) => { if (v) { stopSpeaking(); stopListening(); } return !v; })}
              className={`flex items-center gap-2 px-3.5 h-9 rounded-full text-sm font-medium border transition-colors ${autoSpeak ? "bg-blue-50 border-blue-200 text-blue-700 hover:bg-blue-100" : "bg-slate-50 border-slate-200 text-slate-500 hover:bg-slate-100"}`}>
      ...
      <div className="flex-1 flex min-h-0">
        ...
        <div className="flex-1 flex flex-col min-w-0">
          <div className="flex-1 overflow-y-auto chat-area px-5 py-6">
          ...
          {/* Composer */}
          <div className="shrink-0 bg-white border-t border-slate-200 px-5 py-4">
