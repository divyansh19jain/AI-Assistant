...
def test_coerce_yes_no_captures_natural_answers():
    ...
    assert _coerce_yes_no("just me", "person2.adding_person2") is False
    assert _coerce_yes_no("no", "person2.adding_person2") is False
    assert _coerce_yes_no("my spouse too", "person2.adding_person2") is True
    assert _coerce_yes_no("yes", "person1.married") is True
    assert _coerce_yes_no("mail only", "applicant.wants_email") is False
    assert _coerce_yes_no("email", "applicant.wants_email") is True
    assert _coerce_yes_no("banana split", "person1.married") is None
